...
public class JsonWriter {
    ...
    public JsonWriter(String filename) throws IOException {
        ...
        switch (ext) {
            case "json": jsonWriter(new Spartan("Manish", "java", new ArrayList<>(Arrays.asList(true, false, false, true))));
            break;
            case "xml": xmlWriter(new Spartan("Manish", "java", new ArrayList<>(Arrays.asList(true, false, false, true))));
            break;
            default :
